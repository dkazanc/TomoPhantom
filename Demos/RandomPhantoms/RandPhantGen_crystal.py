...
_stripes_ = {'percentage' : 0.75,
             'maxthickness' : 2.0,
             'intensity' : 0.15,
             'type' : 'mix',
             'variability' : 0.005}

sino_num_artifacts = artefacts_mix(sino_num, _noise_, _zingers_, _stripes_, _sinoshifts_)
